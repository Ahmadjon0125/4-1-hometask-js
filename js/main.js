...
for (something of pokemons){
  ...
  var eggs = document.createElement("span");
  var spawnChance = document.createElement("span");
  var avgSpawn = document.createElement("span");
  ...
  if(something.prev_evolution){
    var elnu = something.prev_evolution[0].number
    var elevo = something.prev_evolution[0].name
  }

  items.setAttribute("class", "iteam")
  elList.appendChild(items)
  items.appendChild(images)
  items.appendChild(id)
  items.appendChild(number)
  items.appendChild(type)
  items.appendChild(height)
  items.appendChild(weight)
  items.appendChild(candy)
  items.appendChild(eggs)
  items.appendChild(spawnChance)
  items.appendChild(avgSpawn)
  items.appendChild(time)
  items.appendChild(multi)
  items.appendChild(weaknesse)
  items.appendChild(evolution)


id.textContent = `id: ${something.id}`;
number.textContent = `number: ${something.number}`
images.src = `${something.img}`
images.setAttribute("alt", "images-pocemens")
images.setAttribute("class", "img")
images.setAttribute("with", "120")
images.setAttribute("height", "120")
type.textContent = `type: ${something.type}`
height.textContent = `height: ${something.height}`
weight.textContent = `weight: ${something.weight}`
candy.textContent = `candy: ${something.candy}`
eggs.textContent = `egg: ${something.egg}`
spawnChance.textContent = `spawn_chance: ${something.spawn_chance}`
avgSpawn.textContent = `avg_spawns: ${something.avg_spawns}`
time.textContent = `spawn_time: ${something.spawn_time}`
multi.textContent = `multi: ${something.multi}`
weaknesse.textContent = `weaknesses: ${something.weaknesses}`
evolution.textContent = `prev_evolution: ${"number:"} ${elnu} ${"name:"} ${elevo}`
}